...
export interface SessionSidebarProps {
  ...
  directoryEntries: DirectoryRailEntry[];
...
export function SessionSidebar({
  ...
  return (
    <Sidebar collapsible="icon">
      <div className="sidebar-rail-pane">
        {DirectoryRail({
      ...
      <div className="sidebar-session-pane">
        <SidebarHeader>
                ...
                <p>
                  {activeHistoryQuery
                    ...
                    : mainSessions.length === 0
                      ...
                      : "Clear the directory filter or start a session in this directory."}
                </p>
                {!historyLoading ? (
                  <Button
                    type="button"
              ...
              sessionSections.map((section) => (
                ...
                >
                  ...
                  {section.sessions.map((session) => {
                    ...
                    const displayName =
                      session.name ?? getDirectoryBasename(session.cwd) ?? "Untitled session";
